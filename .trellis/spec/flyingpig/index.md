...
4. For local state, evidence, logs, metrics, release artifacts, or user data, read [Data and Privacy](data-privacy.md).
5. Apply [Coding](coding.md) to Python, JavaScript, adapters, prompts, and error handling.
6. Select checks from [Verification](verification.md); live authenticated and release operations are gated separately.
