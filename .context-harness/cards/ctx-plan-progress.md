...
## Summary
[x] Distill the dashboard into a state-driven assistant: model setup collapses after configuration; Start owns work-window preparation; request, preparation, running, decision,...
